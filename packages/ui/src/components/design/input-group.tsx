...
function InputGroupInput({ className, ...props }: React.ComponentProps<"input">) {
  const { size: _size, ...rest } = props as unknown as { size?: unknown } & typeof props
  return (
    <Input
